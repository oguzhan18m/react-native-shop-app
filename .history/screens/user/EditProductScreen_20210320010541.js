...
const EditProductScreen = (props) => {
    ...
    },[dispatch, formState.inputValues.title, formState.inputValues.imageUrl,formState.inputValues.description,
         formState.inputValues.price, prodId, formState.formIsValid]);
